...
coverage report. The live console is at **https://autosentinx.com**. This repository is a **monorepo**: the
**API/engine** (FastAPI, repo root) **and** the **Next.js console** in `sentinx-web/` (the Sentinx operator UI).
