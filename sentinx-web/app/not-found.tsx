    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-5 text-center">
        ...
        <p className="mt-1 max-w-sm text-[13px] text-ink-muted">
          This run or observation doesn&apos;t exist. Try the findings list, or start a new audit.
        </p>
        <div className="mt-5 flex gap-2">
          <Link href="/runs/ER-01" className="inline-flex h-9 items-center rounded-md bg-brand px-4 text-sm font-medium text-on-brand hover:bg-brand-strong">
            Go to findings
          </Link>
